<template>
    <div class="confirmation-item py-2">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="row g-0">
